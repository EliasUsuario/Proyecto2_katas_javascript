//28- Dada una lista de álbumes de música, utiliza un bucle para sumar todas las duraciones solo de los álbumes de rock 
...
let totalRockDuracion = 0;
for (const album of albums) {
  if (album.genre === 'Rock') {
    totalRockDuracion += album.duration;
  }
}
console.log('La duración total de los álbumes de Rock es:', totalRockDuracion);