//31- Dada una lista de artistas con sus influencias, utiliza bucles anidados para listar todos los artistas y 
...
for (const artistas of artists) {
  for (const influencias of artistas.influences) {
    console.log(`Artista: ${artistas.name} - Influencia: ${influencias}`);
  }
}